...
m1=ufloat(0.0122,0.0005)
m2=ufloat(0.01945,0.00016)
...
with open("csvData/tabelle3.csv", "w") as f:
    writer= csv.writer(f)
...
x_plot1= np.linspace(0.058,0.17,200)
...
x_plot2= np.linspace(0.058,0.17,200)
